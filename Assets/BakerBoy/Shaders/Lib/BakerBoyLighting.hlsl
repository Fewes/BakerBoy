...
half3 GlobalIllumination(BRDFData brdfData, half3 bakedGI, half occlusion, half3 normalWS, half3 bentNormalWS, half3 viewDirectionWS)
{
    ...
    half3 indirectSpecular = GlossyEnvironmentReflection(reflectVector, brdfData.perceptualRoughness, reflOcclusion);
...
half3 LightingPhysicallyBased(BRDFData brdfData, half3 lightColor, half3 lightDirectionWS, half lightAttenuation, half3 normalWS, half3 bentNormalWS, half3 viewDirectionWS)
{
...
half3 LightingPhysicallyBased(BRDFData brdfData, Light light, half3 normalWS, half3 bentNormalWS, half3 viewDirectionWS)
{
    return LightingPhysicallyBased(brdfData, light.color, light.direction, light.distanceAttenuation * light.shadowAttenuation, normalWS, bentNormalWS, viewDirectionWS);
}
    ...
    half smoothness, half occlusion, half3 emission, half alpha)
{
    ...
    half3 color = GlobalIllumination(brdfData, inputData.bakedGI, occlusion, inputData.normalWS, inputData.bentNormalWS, inputData.viewDirectionWS);
    color += LightingPhysicallyBased(brdfData, mainLight, inputData.normalWS, inputData.bentNormalWS, inputData.viewDirectionWS);
    ...
    for (uint lightIndex = 0u; lightIndex < pixelLightCount; ++lightIndex)
    {
        ...
        color += LightingPhysicallyBased(brdfData, light, inputData.normalWS, inputData.bentNormalWS, inputData.viewDirectionWS);
    }
#endif
